      ...
      <div style={rightStyle}>
        <div className="home-container">
          ...
          <div style={listContainer}>
            ...
            <div className="hover-container" style={listItemStyle} onClick={() => openInNewWindow(`${Find_And_Replace}/Documents/Policies_Services_Forms/Policies/Compliance/SLICLLCM_policy_procedure_manual_31102024.pdf`)}>
              <FontAwesomeIcon icon={faFileAlt} style={iconStyle} className="hover-icon" />
              <span className="hover-text">Complaints Management Policies and Procedure Manual- SLICLL</span>
            </div>
