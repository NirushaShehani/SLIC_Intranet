import notice1Image from '../../assets/notice1.jpg';
import '../../Styles/noticeData.css';

const noticesData = [
    { id: 1, topic: 'SLICL Suba Pathum scholarship awards 2023', image: notice1Image },
    { id: 2, topic: 'SLICL Suba Pathum scholarship awards 2023', image: notice1Image },
    { id: 3, topic: 'SLICL Suba Pathum scholarship awards 2023', image: notice1Image },
